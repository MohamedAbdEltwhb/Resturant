...
import com.example.mm.resturant.activities.adaptor.WaitlistAdapter;
import com.example.mm.resturant.models.SQLiteHelper.WaitlistesTable.WaitlistContract;
import com.example.mm.resturant.models.SQLiteHelper.WaitlistesTable.WaitlistDBhelper;

public class WaitlistesTableActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        add_user = (FloatingActionButton) findViewById(R.id.add_new_guest);
        recyclerView = (RecyclerView) findViewById(R.id.recycler_view);
        waitlist = (ImageView) findViewById(R.id.waitlist_image);
